    ...
    () => [
      {
        id: 1,
        image:
          "https://images.unsplash.com/photo-1598275277521-1885382d523a?w=400&h=300&fit=crop",
      ...
      },
      {
        id: 3,
        image:
          "https://images.unsplash.com/photo-1464822759844-d150baec76b1?w=400&h=300&fit=crop",
  ...
  const filteredTours = useMemo(() => {
    let filtered = tours.filter((tour) => {
      ...
      const matchesDuration =
        durationDays >= durationFilter.min &&
        durationDays <= durationFilter.max;

      // Price filter
      const matchesPrice =
        tour.discountedPrice >= priceFilter.min &&
        tour.discountedPrice <= priceFilter.max;
